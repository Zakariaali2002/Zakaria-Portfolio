            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-full border border-line bg-white/5 text-white/70 transition hover:border-brand/50 hover:text-white"
                >
